...
class CommissionInvoiceController extends Controller
{
    ...
    public function print($id)
    {
        ...
        <table width="100%" cellpadding="2" style="font-size:8.5px;">
            ...
            ' . $expRows . '
            <tr style="font-weight:bold;background-color:#F5EFDF;"><td width="30%">Total Expenses</td><td colspan="2" style="text-align:right;">' . number_format($invoice->total_other_expenses, 2) . '</td></tr>
        </table>';
