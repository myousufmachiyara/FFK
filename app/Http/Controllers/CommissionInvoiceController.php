        ...
        <table border="1" cellpadding="2.5" style="font-size:7.5px;">
            <thead>
                <tr style="background-color:#1B3A5C;color:#ffffff;font-weight:bold;text-align:center;">
                    <th width="15%">Item</th><th width="5%">Qty</th><th width="6%">G.Wt</th><th width="6%">N.Wt</th>
        ...
        foreach ($invoice->items as $index => $item) {
            ...
            $html .= '
                <tr style="background-color:' . $rowBg . ';">
                    ...
                    <td width="6%" style="text-align:right;">' . number_format($item->gross_weight, 2) . '</td>
                    <td width="6%" style="text-align:right;">' . number_format($item->net_weight, 2) . '</td>
