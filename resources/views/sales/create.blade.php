      ...
      <section class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted small mt-2 mb-0">
            ...
            If the <strong>Vendor</strong> paid it (requires a Vendor selected above), it increases what we owe
            the Vendor. If <strong>Company (FFK)</strong> paid it, pick which account we owe instead.
          </p>
        </div>
      </section>
    </div>
...
function calcRow(idx) {
    ...
    // Stock check (informational — server always re-validates)
...
function addExpenseRow() {
    ...
    <tr data-erow="${idx}">
        ...
        <td><select name="expenses[${idx}][payee_account_id]" class="form-control select2-js payee-select" id="payee${idx}">
